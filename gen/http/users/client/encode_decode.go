...
func EncodeRegisterRequest(encoder func(*http.Request) goahttp.Encoder) func(*http.Request, any) error {
	return func(req *http.Request, v any) error {
		p, ok := v.(*users.UserRegisterPayload)
		if !ok {
			return goahttp.ErrInvalidType("users", "register", "*users.UserRegisterPayload", v)
		}
...
func EncodeLoginRequest(encoder func(*http.Request) goahttp.Encoder) func(*http.Request, any) error {
	return func(req *http.Request, v any) error {
		p, ok := v.(*users.UserLoginPayload)
		if !ok {
			return goahttp.ErrInvalidType("users", "login", "*users.UserLoginPayload", v)
		}
